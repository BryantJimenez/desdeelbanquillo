					...
					<div class="col-xl-5 col-12 mb-3"> 
						<div class="d-flex justify-content-start text-white card-left-radius border-solid border-width-5px border-grey"> 
							<div class="rounded-circle border-solid border-width-5px border-grey">
								<img src="{{ asset('/admins/img/logoredondo.png') }}" class="card-logo-rounded" alt="Logo">
							</div>
					...
					<div class="col-xl-7 col-12">
						<div class="row">
							<div class="col-xl-6 col-md-6 col-sm-6 col-12 mb-3"> 
								<div class="d-flex justify-content-start text-white card-left-radius border-solid border-width-5px border-grey"> 
									<div class="rounded-circle border-solid border-width-5px border-grey">
										<img src="{{ asset('/admins/img/icons/news.png') }}" class="card-logo-rounded" alt="Noticias">
									</div>
							...
							<div class="col-xl-6 col-md-6 col-sm-6 col-12 mb-3"> 
								<div class="d-flex justify-content-start text-white card-left-radius border-solid border-width-5px border-grey"> 
									<div class="rounded-circle border-solid border-width-5px border-grey">
										<img src="{{ asset('/admins/img/icons/usuarios.png') }}" class="card-logo-rounded" alt="Usuarios">
									</div>
									<div class="py-2 counter-card">
...
<script type="text/javascript">
	var options = {
		...
		series: [{{ implode(",", $data['categories_values']) }}],
	...
	var categories_views = new ApexCharts(document.querySelector("#categoriesViews"), options);
	categories_views.render();
