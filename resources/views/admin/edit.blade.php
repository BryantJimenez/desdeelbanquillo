						...
						<form action="{{ route('profile.update', ['slug' => Auth::user()->slug]) }}" method="POST" class="form" id="formProfile" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input type="file" name="photo" accept="image/*" id="input-file-now" class="dropify" data-height="125" data-max-file-size="20M" data-allowed-file-extensions="jpg png jpeg web3" data-default-file="{{ '/admins/img/admins/'.Auth::user()->photo }}" />
								</div>
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									<div class="row">
										<div class="form-group col-lg-12 col-md-12 col-12">
											...
											<input class="form-control" type="text" name="name" required placeholder="Introduzca un nombre" value="{{ Auth::user()->name }}" id="name">
										</div>

										<div class="form-group col-lg-12 col-md-12 col-12">
											<label class="col-form-label">Apellido<b class="text-danger">*</b></label>
											<input class="form-control" type="text" name="lastname" required placeholder="Introduzca un apellido" value="{{ Auth::user()->lastname }}" id="lastname">
										</div>
									</div> 
								</div>
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<select class="form-control" name="type" required>
										...
										<option value="1" @if(Auth::user()->type=="1") selected @endif>Super Administrador</option>
										<option value="2" @if(Auth::user()->type=="2") selected @endif>Administrador</option>
									</select>
								</div>
