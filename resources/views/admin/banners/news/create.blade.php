			...
			<div class="widget-header">
				<div class="row">
					<div class="col-xl-12 col-md-12 col-sm-12 col-12">
						<h4>Crear Banner / Página Noticias</h4>
					</div>                 
				</div>
			</div>
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('banners.noticias.store') }}" method="POST" class="form" id="formBannerCreate" enctype="multipart/form-data">
							@csrf
							<div class="row">
								...
								<div class="form-group col-12">
									...
									<select class="form-control" name="featured" required id="banner-type">
										<option value="5" @if(old('featured')=="5") selected @endif>Noticias Superior</option>
										<option value="6" @if(old('featured')=="6") selected @endif>Noticias Alargado</option>
										<option value="7" @if(old('featured')=="7") selected @endif>Noticias Inferior</option>
									</select>
								</div>
