			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('banners.noticias.update', ['slug' => $banner->slug]) }}" method="POST" class="form" id="formBannerEdit" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<div class="row">
								...
								<div class="form-group col-12">
									...
									<select class="form-control" name="featured" required id="banner-type">
										<option value="5" @if($banner->featured=="5") selected @endif>Noticias Superior</option>
										<option value="6" @if($banner->featured=="6") selected @endif>Noticias Alargado</option>
										<option value="7" @if($banner->featured=="7") selected @endif>Noticias Inferior</option>
									</select>
								</div>
								...
								<div class="form-group col-12">
									...
									@elseif($banner->featured=="5" || $banner->featured=="7")
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										...
										<a href="{{ route('banners.noticias.index') }}" class="btn btn-secondary">Volver</a>
									</div>
								</div> 
							</div>
						</form>
