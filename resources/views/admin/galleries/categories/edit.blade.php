			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('galerias.categorias.update', ['slug' => $category->slug]) }}" method="POST" class="form" id="formCategory">
							@csrf
							@method('PUT')
							<div class="row">
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										...
										<a href="{{ route('galerias.categorias.index') }}" class="btn btn-secondary">Volver</a>
									</div>
								</div> 
							</div>
						</form>
